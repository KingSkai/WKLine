...
@interface WK_KLineModel : NSObject
 ...
 *  前一个Model
 */
@property (nonatomic, strong) WK_KLineModel *PreviousKlineModel;

/**
 *  父ModelArray:用来给当前Model索引到Parent数组
 */
@property (nonatomic, strong) WK_KLineGroupModel *ParentGroupModel;
